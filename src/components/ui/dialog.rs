    ...
    view! {
        <Show when=move || show_settings.get() fallback=|| ()>
            <div class="fixed inset-0 z-[100]">
                ...
                <div 
                    class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-popover shadow-xl border border-border p-4 w-96 max-w-[90vw]"
                    on:click=move |e| {
                        e.stop_propagation();
                    }
                >
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-popover-foreground">Settings</h3>
                        <button
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-popover-foreground mb-2">
                                Animation Speed
                            </label>
                            <div class="space-y-2">
                                <div class="relative">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-1">
                                <button
                                    class=move || format!(
                                        "px-3 py-2 text-xs font-medium border transition-colors cursor-pointer {}",
